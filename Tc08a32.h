...
//2010.11.08, add
int WINAPI StartSendSignalTone( WORD wChnlNo, int nFreq1, int nFreq2, int iSigLen);
//end
...
int WINAPI SetPlayMemBuf(DWORD wStartPlayDataLen,DWORD wPlayBufLen);
int WINAPI StartPlayMem(WORD wChnlNo);

int WINAPI SendToBuff ( WORD wChnlNo, char *PlayBuf, DWORD dwPlayLen ,DWORD *dwDateSize);
//nMode:0
int WINAPI SendToBuffMuti(WORD wChnlNo, char *PlayBuf, DWORD dwPlayLen, int nMode);
int WINAPI StopPlayMem(WORD wChnlNo, WORD wMode);
int WINAPI DJLM_D160A_EnableCopyRecData(WORD wChnl,BOOL isCopy);
int WINAPI DJLM_D160A_CopyRecData(WORD wChnl,BYTE* pDataBuf, WORD wBufSize); 

//2007, add by Jiangzq
BOOL WINAPI RingDetect_Ex(WORD wChnlNo);
//end

int WINAPI InitMP3Id3tag(char *pMP3Title,char *pMP3Artist,char *pMP3Album,char *pMP3Year,char *pMP3Comment,char *pMP3Genre);//Add by terry 2010-11-08 for mp3
//2010.06.09, add by yezm
void WINAPI GetSysInfo_256( TC_INI_TYPE_256 *TmpIni);
//end

//Add by terry 2010-11-08 for jpg bmp start 
int WINAPI DJFax_AddPageHeaderToFaxFile(char *FaxFileName, char* FaxFrom, char *FaxTo, char *FaxSubbject, char *DataTime , char *TargetFileName,int *PageNo);
int WINAPI DJFax_AddPageHeaderToFaxFileEx(char *FaxFileName, char *FaxSubbject, int X,int Y, int CharSize, char *TargetFileName,int *PageNo);

int WINAPI DJFax_AddPicFileToFaxFile(char *FaxFileName,char *PicFileName, int X,int Y, char *TargetFileName,int DoubleBitFlag,int *PageNo);
int WINAPI DJFax_CvtPicFileToBfx(char *cbPicFileName,DWORD X,DWORD Y,char  *cbFaxFileName,int DoubleBitFlag);

int WINAPI DJFax_GetOnePageFromTiff(char *TiffFileName,int PageNo,char *TargetFileName);
int WINAPI DJFax_GetTotalPageFromTiff(char *TiffFileName,int *TotalPage);
int WINAPI DJFax_GetTotalPageFromBfx(char *BFXFileName,int *TotalPage);
int WINAPI DJFax_AddPageFooterToFaxFile(char *FaxFileName,char *FaxSubbject,int X,int Y,int CharSize,char *TargetFileName,int *PageNo);
int WINAPI DJFax_CvtFaxFileToPicFile(char *FaxFileName,char *PicFileName,int *PageNo);
int WINAPI DJFax_GetFaxFileTotalPage(char *FaxFileName,int *TotalPage);
int WINAPI DJFax_SaveOnePageFromTiff(char *TiffFileName,int PageNo,char *TargetFileName);
//Add by terry 2010-11-08 for jpg bmp end 

int WINAPI LoadDSPDNFDP300(void);
#ifdef __cplusplus
}
#endif
